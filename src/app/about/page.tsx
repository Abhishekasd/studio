  ...
  return (
    <div className="bg-background text-foreground min-h-screen">
      <div className="relative z-10 max-w-4xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
        ...
        <section className="space-y-8 text-lg leading-relaxed text-foreground/90 text-justify">
          <h2 className="text-3xl font-bold text-secondary text-center">Our Mission</h2>
          <p>
        ...
        <section className="space-y-8 text-lg leading-relaxed text-foreground/90 text-justify">
          <h2 className="text-3xl font-bold text-secondary text-center">What We Offer</h2>
